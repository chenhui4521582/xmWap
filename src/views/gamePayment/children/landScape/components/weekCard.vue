  ...
  export default {
    ...
    methods:{
      ...
      openPop(type){
        ...
        this.$marchSetsPoint(type?'A_H5PT0058004146':'A_H5PT0058004145',{edition: 'landScopeMall', project_id: parent.SDK.getGameType()})
        this.$emit('openPop',type)
      },
      expand(type){
        //游戏内-商城-展开周卡点击 A_H5PT0058004148
        //游戏内-商城-展开月卡点击 AA_H5PT0058004149
        this.$marchSetsPoint(type?'A_H5PT0058004149':'A_H5PT0058004148',{edition: 'landScopeMall',project_id: parent.SDK.getGameType()})
        this.isExpand=true
      }
    },
    watch:{
